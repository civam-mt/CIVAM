(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['ngx-audio-player'] = {}, global.ng.core, global.ng.material.table, global.ng.material.paginator, global.rxjs, global.ng.material.slider, global.ng.material.formField, global.ng.material.expansion, global.ng.material.card, global.ng.material.button, global.ng.common, global.ng.forms, global.ng.material.icon));
}(this, (function (exports, i0, table, paginator, rxjs, slider, formField, expansion, card, button, common, forms, icon) { 'use strict';
    ...
    AudioPlayerComponent.propDecorators = {
        playlist: [{ type: i0.Input }],
        matPaginator: [{ type: i0.ViewChild, args: [paginator.MatPaginator, { static: false },] }],
        displayTitle: [{ type: i0.Input }],
        displayPlaylist: [{ type: i0.Input }],
        ...
        disablePositionSlider: [{ type: i0.Input }],
        displayArtist: [{ type: i0.Input }],
        displayDuration: [{ type: i0.Input }],
        tableHeader: [{ type: i0.Input }],
        titleHeader: [{ type: i0.Input }],
        artistHeader: [{ type: i0.Input }],
        durationHeader: [{ type: i0.Input }],
        trackEnded: [{ type: i0.Output }],
        player: [{ type: i0.ViewChild, args: ['audioPlayer', { static: true },] }],
        startOffset: [{ type: i0.Input }],
        endOffset: [{ type: i0.Input }]
    };
    ...
    */
    ...
    SecondsToMinutesPipe.decorators = [
        { type: i0.Pipe, args: [{ name: 'secondsToMinutes' },] }
    ];
