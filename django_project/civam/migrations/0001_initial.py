# Generated by Django 2.2.6 on 2020-05-26 04:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cataloger', models.CharField(blank=True, max_length=511, null=True)),
                ('cataloge_date', models.CharField(blank=True, max_length=511, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_notes_or_rights_and_reproduction', models.CharField(blank=True, max_length=127, null=True)),
                ('location_of_original', models.CharField(blank=True, max_length=127, null=True)),
                ...
                ('cataloger', models.CharField(blank=True, max_length=511, null=True)),
                ('catalog_date', models.CharField(blank=True, max_length=511, null=True)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('modified_on', models.DateTimeField(auto_now=True)),
