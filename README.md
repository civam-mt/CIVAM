...
* `psql`
* `\c django_db`
* `DROP TABLE civam_collection, civam_image, civam_item, civam_story, civam_video, civam_collectiongroup, civam_personorinstitute, civam_narrative, civam_keyword;`
